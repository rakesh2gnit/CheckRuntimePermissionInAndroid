...
public class MainActivity extends BaseActivity implements PermissionChecker.OnRequestPermissionResult {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChkConn = (Button) findViewById(R.id.btnChkConn);
        ...
        btnChkConn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if (NetworkUtil.isInternetAvailable(MainActivity.this)) {
                    Log.e("connection type:", NetworkUtil.getConnectivityStatusString(MainActivity.this));
                    Log.e("is reachable:", "" + NetworkUtil.isReachable(MainActivity.this));
                    if (NetworkUtil.getConnectivityStatusString(MainActivity.this).equalsIgnoreCase("Wifi enabled") ||
                            NetworkUtil.getConnectivityStatusString(MainActivity.this).equalsIgnoreCase("4g")) {
                        Toast.makeText(MainActivity.this, NetworkUtil.getConnectivityStatusString(MainActivity.this), Toast.LENGTH_SHORT).show();
                        if (NetworkUtil.isReachable(MainActivity.this)) {
                            Log.e("reachable:", "Do your code here.");
                        } else {
                            Log.e("not reachable:", "Check your connection." + NetworkUtil.isReachable(MainActivity.this));
                        }
                    } else {
                        Toast.makeText(MainActivity.this, "Poor network connection.", Toast.LENGTH_SHORT).show();
                        if (NetworkUtil.isReachable(MainActivity.this)) {
                            Log.e("reachable:", "Do your code here.");
                        } else {
                            Log.e("not reachable:", "Check your connection." + NetworkUtil.isReachable(MainActivity.this));
